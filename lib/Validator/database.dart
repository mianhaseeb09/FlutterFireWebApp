...
class Database{
  ...
  static Future<void>addItem({
    ...
    await documentReference.set(data).whenComplete(() => print("Note item inserted to database"))
  ...
  static Future<void>updateItem({
    ...
    await documentReference.set(data).whenComplete(() => print("Note item Updated in the database"))
        .catchError((e)=>print(e));
  }
  ...
  static Future<void>deleteItem({
    ...
    DocumentReference documentReference=_mainCollection.doc(userId).collection('items').doc(docId);
    await documentReference.delete().whenComplete(() => print("Note item deleted from database"))
        .catchError((e)=>print(e));
  }
}